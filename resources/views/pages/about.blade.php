...
@section('title', 'About eCommerce Bootstrap HTML Template - Furnish')
    ...
    <section class="py-lg-8 py-5">
      <div class="container">
        <div class="row align-items-center g-5 mx-lg-8">
          <div class="col-md-6">
            <img src="{{ asset('assets/images/about.jpg') }}" alt="Living room" class="img-fluid ">
          </div>
          <div class="col-md-6">
            <div class="ms-lg-8">
      ...
      <div class="container text-center">
        ...
        <div class="row g-4">
          <div class="col-6 col-md-3">
            <div class="mx-md-8">
            <img src="{{ asset('assets/images/avatar-1.jpg') }}" class="rounded-circle img-fluid mb-3" alt="Team member">
            </div>
            <div class="lh-1">
          ...
          <div class="col-6 col-md-3">
             <div class="mx-md-8">
            <img src="{{ asset('assets/images/avatar-2.jpg') }}" class="rounded-circle img-fluid mb-3" alt="Team member">
            </div>
            <div class="lh-1">
            <h3 class=" mb-1 h5">
          Michael Brown</h3>
          ...
          <div class="col-6 col-md-3">
             <div class="mx-md-8">
            <img src="{{ asset('assets/images/avatar-3.jpg') }}" class="rounded-circle img-fluid mb-3" alt="Team member">
            </div>
            <div class="lh-1">
          ...
          <div class="col-6 col-md-3">
            <div class="mx-md-8">
            <img src="{{ asset('assets/images/avatar-4.jpg') }}" class="rounded-circle img-fluid mb-3" alt="Team member">
            </div>
            <div class="lh-1">
